...
var ConfigurationRepository = /** @class */ (function (_super) {
    __extends(ConfigurationRepository, _super);
    function ConfigurationRepository(listResolver, web) {
        return _super.call(this, ConfigurationEntity, listResolver, web) || this;
    }
    ConfigurationRepository.prototype.Selects = function () {
        var a = _super.prototype.Selects.call(this);
    ...
    ConfigurationRepository.prototype.GetByKey = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var configKeyField, caml, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        configKeyField = Constants.Common.DataAccess.Const.Fields.CONFIGURATION_KEY;
                        caml = "<Where><Eq><FieldRef Name='" + configKeyField + "' /><Value Type='Text'>" + key + "</Value></Eq></Where>";
                        return [4 /*yield*/, _super.prototype.ReadByCamlQueryCaml.call(this, caml, 1)];
                    case 1:
                        data = _a.sent();
    ...
    ConfigurationRepository.prototype.loadItem = function (item) {
        var e = _super.prototype.loadItem.call(this, item);
    ...
    ConfigurationRepository.prototype.createItem = function (item) {
        var base = _super.prototype.createItem.call(this, item);
